...
type TaskDialogRequest =
  ...
  | { mode: 'preview'; taskId: string; autoEdit?: boolean; autoCloseAfterComplete?: boolean }
...
type TaskDialogContextValue = {
  ...
  openTaskPreview: (taskId: string, opts?: { autoEdit?: boolean; autoCloseAfterComplete?: boolean }) => void
